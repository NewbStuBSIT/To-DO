...
$tasks = "SELECT*FROM task  WHERE user_id = '$id'";
...
if(isset($_POST['btn-tasks'])){
  ...
  $sql = "INSERT INTO task(task,user_id) VALUES('$task','$id')";
  $usercredentials->runBaseQuery($sql);
  ...
  <div class="row" style="min-height: 100vh;">
    ...
    <?php if ($alltask != null): ?>
      <?php foreach ($alltask as $task): ?>
        <tr>
          <td><?=$task['task']?></td>
          <td><a href="" class="btn btn-success">EDIT</a> <a href="delete.php?id=<?=$task['id']?>" class="btn btn-danger">DELETE</a></td>
        </tr>
      <?php endforeach; ?>
    <?php endif; ?>
  </table>
